...
console.log(milDonusturucu(1));  // 0.621371 Mil
...
console.log(feetDonusturucu(100));  // 3.2808398950131235 feet
...
console.log(notHesapla(95));  // A aldın
console.log(notHesapla(82));  // B aldın
console.log(notHesapla(50));  // F aldın
